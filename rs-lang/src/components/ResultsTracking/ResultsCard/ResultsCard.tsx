  ...
  return (
    <div className="results-card ml-auto w-1/2 bg-gray-700 max-w-[280px] max-h-[330px] p-4">
      <ul className="list-none flex items-center justify-evenly">
        <li className="text-yellow-500 font-medium text-[8px] leading-[10px] underline underline-offset-4 mr-2">
          Результаты
        </li>
      ...
      <div className="flex items-center justify-center">
        <LoaderButton
          type="button"
          className="results__btn_retry w-14 h-4 bg-emerald-700 hover:bg-emerald-600 transition-colors text-white px-1 mr-2"
        >
        ...
        <LoaderButton
          type="button"
          className="results__btn_retry w-14 h-4 bg-emerald-700 hover:bg-emerald-600 transition-colors text-white px-1"
        >
          <span className="flex items-center justify-around text-[7px] leading-[7px]">
            Учебник{" "}
